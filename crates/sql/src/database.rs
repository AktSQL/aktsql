...
pub fn pending_database_deletion(
    mut form: ConnectionForm,
    database: &str,
...
pub fn rename_database_statement(
...
pub fn alter_database_charset_statement(
...
pub fn create_postgres_database_statement(draft: &CreateDatabaseDraft) -> String {
...
pub fn edit_database_charset_template(
    driver: DatabaseDriver,
    database: &str,
    charset: &str,
    collation: &str,
...
pub fn drop_database_template(driver: DatabaseDriver, database: &str) -> String {
    match driver {
        DatabaseDriver::MySql | DatabaseDriver::MariaDb | DatabaseDriver::TiDb => {
...
pub fn database_action_target(driver: DatabaseDriver, database: &str) -> String {
