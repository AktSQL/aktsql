use crate::{i18n, theme, Akt};
use engine::product::APP_SHORT_NAME;
use engine::{
    AlterDatabaseCharsetDraft, AlterTableDraft, AlterTableField, AlterTableTab,
...
use engine::{ConnectionField, ConnectionForm, ConnectionManager, DatabaseDriver, Language};
use engine::{
...
mod shell;
mod sidebar;
pub(in crate::view) use database_workbench::{
    database_workbench_view, detail_section_label, query_sidebar_schema,
};
use form::*;
pub(in crate::view) use query_workspace::{chip, schema_refresh_button};
