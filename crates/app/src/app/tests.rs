...
#[test]
fn create_table_opens_form_without_query_navigation() {
    let mut app = Akt::default();
    app.connection_manager
        .save_current()
        .expect("default connection draft should save");
...
fn live_mysql_move_column_rebuild_succeeds() {
    ...
    let details = db::load_table_details(form.clone(), String::from("aktsql_reorder_probe"))
    ...
    let reordered = db::load_table_details(form.clone(), String::from("aktsql_reorder_probe"))
...
fn index_column_append_keeps_comma_list_unique() {
    ...
    engine::schema::append_index_column(&mut columns, "NAME");
    assert_eq!(columns, "name, created_at");

    engine::schema::append_index_column(&mut columns, "email");
...
fn gui_never_exposes_sql_or_plan_review_language() {
    let checked_sources = [
        include_str!("../app.rs"),
        include_str!("../../../ui/src/view.rs"),
        include_str!("../../../ui/src/view/database_workbench.rs"),
        include_str!("../../../ui/src/view/dialogs.rs"),
        include_str!("../../../ui/src/view/generic.rs"),
        include_str!("../../../ui/src/view/query_workspace.rs"),
        include_str!("../../../ui/src/view/schema_designer.rs"),
        include_str!("../../../ui/src/view/schema_designer/alter_table.rs"),
        include_str!("../../../ui/src/view/schema_designer/create_table.rs"),
    ];
    let forbidden = [
        "Change Plan",
        "变更计划",
...
#[test]
fn create_database_submit_runs_directly_without_query_navigation() {
    let mut app = Akt::default();
    app.connection_manager
        .save_current()
        .expect("default connection draft should save");
