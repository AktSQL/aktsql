...
impl akt_ui::ViewState for Akt {
    ...
    fn schema_object_expanded(&self, index: usize) -> bool {
        self.schema_object_expanded(index)
    }

    fn schema_object_menu_open(&self, index: usize) -> bool {
        self.schema_object_menu_open(index)
    }
