...
use crate::connector::ConnectionTestReport;
use crate::i18n::{self, Language};
use crate::persistence;
use crate::query::{
    DatabaseDetails, QueryExecutionOutcome, QueryWorkspace, SchemaLoadOutcome, SchemaObject,
    SchemaObjectKind, TableColumnDetail, TableDetails,
};
        ...
        match message {
            ...
            Message::AddCreateTableIndexForColumn(index) => {
                ...
                draft.indexes.push(CreateTableIndexDraft::with_type(
                    ...
                    &column_name,
                    crate::schema::default_index_type(driver),
                ));
            ...
            Message::AppendCreateTableIndexColumn(index, column_name) => {
                ...
                crate::schema::append_index_column(&mut index_draft.columns, &column_name);
                self.create_table_tab = CreateTableTab::Indexes;
                self.status_message = format!(
                    "{}: {column_name}",
            ...
            Message::AlterTableTabSelected(tab) => {
                ...
                match tab {
                    ...
                    AlterTableTab::Indexes => {
                        ...
                        draft.index_type = String::from(crate::schema::default_index_type(
            ...
            Message::ToggleAlterTableIndexColumn(column_name) => {
                ...
                draft.operation = AlterTableOperation::AddIndex;
                crate::schema::toggle_index_column(&mut draft.index_columns, &column_name);
