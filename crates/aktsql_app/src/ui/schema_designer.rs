...
fn alter_table_index_type_pick_list(
    ...
    pick_list(
        crate::schema::index_type_options(driver),
        Some(crate::schema::normalized_index_type(driver, selected)),
...
fn alter_table_constraint_type_pick_list(
    ...
    let options = crate::schema::constraint_type_options(driver);
    if options.is_empty() {
        return container(
            text(crate::schema::default_constraint_type(driver))
                .size(12)
                .wrapping(Wrapping::None)
                .style(theme::secondary_text),
        )
    ...
    pick_list(
        options,
        Some(crate::schema::normalized_constraint_type(driver, selected)),
