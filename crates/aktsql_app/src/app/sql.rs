...
mod query;
#[cfg(test)]
pub(in crate::app) use alter_table::move_column_statement;
pub(in crate::app) use alter_table::{alter_table_statement, last_table_part};
pub(in crate::app) use create_table::create_table_statement;
pub(in crate::app) use database::*;
use dialect::*;
pub(in crate::app) use query::*;

pub(super) fn table_column_definition_tail(column: &TableColumnDetail) -> String {
...
pub(super) fn normalized_column_default(column: &TableColumnDetail, default_value: &str) -> String {
...
pub(super) fn is_sql_default_expression(value: &str) -> bool {
...
pub(super) fn column_type_uses_quoted_default(data_type: &str) -> bool {
...
pub(super) fn sanitized_column_extra(extra: &str) -> String {
    extra
        .split_whitespace()
...
pub(super) fn mysql_index_columns_sql(
    columns: &str,
